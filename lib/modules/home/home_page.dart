...
Com este conceito de trazer sempre inovação aos nossos clientes, estamos sempre atualizados com as tendências tecnológicas para oferecer o que há de mais moderno na prestação de serviços para empresas públicas e privadas do ramo da biotecnologia. Desde o estágio da elaboração do projeto de pesquisa até a validação dos produtos, da pesquisa básica à aplicada, do diagnóstico ao medicamento, pode contar conosco.  """,
                                    ...
                                    SizedBox(
                                        ...
                                        child: ElevatedButton(
                                            ...
                                            onPressed: () {
                                              Get.toNamed(AppRoutes.publicationsPage);
                                            },
                                            child: const Text(
                            ...
                            AnimatedCrossFade(
                                firstChild: UncomplicatedBiotechnology()
                                    .biotecBannerColum(),
                                secondChild: UncomplicatedBiotechnology()
                                    .biotecBannerRow(),
                            ...
                            AnimatedCrossFade(
                              firstChild: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: ServiceMultiomicaBloc().genomicaBloc(
                                          "big"),
                                    ),
                                    const SizedBox(width: 20),
                                    Expanded(
                                      child: ServiceMultiomicaBloc()
                                          .metagenomicaBloc("big"),
                                    ),
                                    const SizedBox(width: 20),
                                    Expanded(
                                        child: ServiceMultiomicaBloc()
                              ...
                              secondChild: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    ServiceMultiomicaBloc().metagenomicaBloc(
                                        "small"),
                                    const SizedBox(height: 15),
                            ...
                            Row(
                              ...
                              children: [
                                ctrl.clientBannerCount == 1
                                    ? Flexible(
                                    child: Image.asset(AppImages.logos1To10))
                                    : ctrl.clientBannerCount == 2
                                    ? Flexible(
                                    child: Image.asset(AppImages.logos11To20))
                                    : ctrl.clientBannerCount == 3
                                    ? Flexible(
                                    child: Image.asset(AppImages.logos21To30))
                                    : ctrl.clientBannerCount == 4
                                    ? Flexible(
                                    child: Image.asset(AppImages.logos31To40))
                                    : Flexible(
                                    child: Image.asset(AppImages.logos41To50)),
                                ...
                                ctrl.clientBannerCount == 1 && widthMedia > 600
                                    ...
                                    : widthMedia > 600
                                    ? Flexible(
                                    child: Image.asset(AppImages.logos51To60))
                                    : Container()
                              ],
                            ),
                            const SizedBox(height: 40),
